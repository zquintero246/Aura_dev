                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="540"
                    ...
                    <?php if(isset($actionText)): ?>
                        <tr>
                            <td align="center" style="padding:32px 0;">
                                ...
                                ?>
                                <a href="<?php echo new \Illuminate\Support\EncodedHtmlString($overrideUrl); ?>" target="_blank" rel="noopener"
                    ...
                    <tr>
                        <td align="center" style="font-size:11px; color:#374151; padding-top:24px;">
                            © <?php echo new \Illuminate\Support\EncodedHtmlString($year); ?> AURA. Todos los derechos reservados.
                        </td>
                    </tr>
...
<?php /**PATH C:\Users\Santiago\Documents\AURA\Aura_dev\backend\resources\views/vendor/notifications/email.blade.php ENDPATH**/ ?>