  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Join Aura Platform today! Create your account with email verification or sign up instantly using GitHub/Google. Secure registration with modern authentication."
        />
        <meta
          property="og:title"
          content="Create Account - Aura Platform | Secure Registration & Social Login"
        />
        <meta
      ...
      <main className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 py-12">
        {/* Fondo con partículas se mantiene fuera de main */}
              ...
              <div className="px-6 sm:px-8 md:px-10 py-8">
                ...
                <div className="mt-10 flex justify-center">
                  <Button
                    ...
                    size="medium"
                  >
                    {isLoading ? 'Enviando código...' : 'Verificar correo'}
                  </Button>
                </div>
